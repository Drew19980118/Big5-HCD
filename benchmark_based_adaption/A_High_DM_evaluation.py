...
if __name__ == "__main__":
    ...
    csv_file_path = '../test_interlocutor_dialogues/A_High_DM_example_dialogues.csv'

    output_csv_path = 'average_-0.5_std_aggregation_output_adapted_dialogues/A_High_DM_HCD.csv'
