...
if __name__ == "__main__":
    ...
    csv_file_path = '../sampled_HHDs/N_Middle_DE_example_dialogues.csv'

    output_csv_path = 'data/average_-1_std_aggregation_output_adapted_dialogues/N_Middle_DE_HCD.csv'
