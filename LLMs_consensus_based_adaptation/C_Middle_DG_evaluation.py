...
if __name__ == "__main__":
    ...
    csv_file_path = '../sampled_HHDs/C_Middle_DG_example_dialogues.csv'

    output_csv_path = 'data/average_-1_std_aggregation_output_adapted_dialogues/C_Middle_DG_HCD.csv'
