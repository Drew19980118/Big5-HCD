...
human_human_csv = '../test_interlocutor_dialogues/O_High_AH_example_dialogues.csv'
human_computer_csv = '../role_model_synthetized_HCD/O_High_BJ_role_model_synthetized_HCD.csv'
deepseek_output_file = 'deepseek_evaluation_results/O_High_AH.txt'
llama3_output_file = 'llama3_evaluation_results/O_High_AH.txt'
gemma2_output_file = 'gemma2_evaluation_results/O_High_AH.txt'
