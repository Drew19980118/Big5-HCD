...
human_human_csv = '../test_interlocutor_dialogues/E_Middle_EC_example_dialogues.csv'
human_computer_csv = '../role_model_synthetized_HCD/E_Middle_EC_role_model_synthetized_HCD.csv'
deepseek_output_file = 'deepseek_evaluation_results/E_Middle_EC.txt'
llama3_output_file = 'llama3_evaluation_results/E_Middle_EC.txt'
gemma2_output_file = 'gemma2_evaluation_results/E_Middle_EC.txt'
