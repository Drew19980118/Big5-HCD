...
human_human_csv = '../test_interlocutor_dialogues/C_Middle_BJ_example_dialogues.csv'
human_computer_csv = '../role_model_synthetized_HCD/C_Middle_BJ_role_model_synthetized_HCD.csv'
